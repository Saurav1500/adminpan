        ...
        <main>
            ...
            <div class="search">
               <form action="" method="GET"> 
                <input type="text" id="search_seat" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>"><button type="submit"><span class="material-symbols-outlined">
                        search</span></button>
                </form>
                    </div>
                    <table>
                ...
                <tbody>
                    ...
                    $sql = "select * from passengers where concat(name,contact) LIKE '$filtervalue%'";
